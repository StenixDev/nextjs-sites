          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              <div className="w-10 h-10 bg-patriotic-red rounded-full flex items-center justify-center">
                <span className="text-white font-serif font-bold text-xl">PH</span>
              </div>
              <span className="font-serif font-bold text-xl">Patriotic Hearts</span>
            </div>
            ...
            <p className="text-sm text-gray-400">
              © 2025 PatrioticHearts. All rights Reserved Worldwide.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                <MapPin className="h-5 w-5 text-patriotic-red flex-shrink-0 mt-0.5" />
                <span className="text-gray-300 text-sm">{CONTACT_INFO.address}</span>
              </li>
              <li className="flex items-center space-x-3">
                <Phone className="h-5 w-5 text-patriotic-red flex-shrink-0" />
                <a
              ...
              <li className="flex items-center space-x-3">
                <Mail className="h-5 w-5 text-patriotic-red flex-shrink-0" />
                <a
