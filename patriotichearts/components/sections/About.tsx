        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <Card className="h-full">
            ...
            <p className="text-gray-600 mb-4">
              <strong>Patriotic Hearts Inc.</strong> is a non-profit organization
              established under California law. Our primary mission is to assist
              US Military, Veterans, and their families in having happy,
